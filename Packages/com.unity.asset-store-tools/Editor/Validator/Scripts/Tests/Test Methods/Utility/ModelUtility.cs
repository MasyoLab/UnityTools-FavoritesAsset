...
namespace AssetStoreTools.Validator.TestMethods.Utility
{
    internal static class ModelUtility
    {
        ...
        private static UnityEditor.Editor _modelImporterEditor = null;
#endif
        ...
        private static Dictionary<UnityObject, List<LogEntry>> GetImportLogsLegacy(params UnityObject[] models)
        {
            ...
            foreach (var model in models)
            {
                ...
                UnityEditor.Editor.CreateCachedEditorWithContext(new UnityObject[] { modelImporter }, model, modelImporterEditorType, ref _modelImporterEditor);
